...
e(o)?r=o:t=o+n}}function T(e,t,r){var o=this
...
if(t<l)break
t-=l}return r+a}function D(e,t){return t>=e.first&&t<e.first+e.size}function P(e,t){return String(e.lineNumberFormatter(t+e.firstLineNumber))}function H(e,t,r){if(void 0===r&&(r=null),!(this instanceof H))return new H(e,t,r)
this.line=e,this.ch=t,this.sticky=r}function E(e,t){return e.line-t.line||e.ch-t.ch}function I(e,t){return e.sticky==t.sticky&&0==E(e,t)}function F(e){return H(e.line,e.ch)}function R(e,t){return E(e,t)<0?t:e}function B(e,t){return E(e,t)<0?e:t}function j(e,t){return Math.max(e.first,Math.min(t,e.first+e.size-1))}function V(e,t){if(t.line<e.first)return H(e.first,0)
var r=e.first+e.size-1
return t.line>r?H(r,M(e,r).text.length):K(t,M(e,t.line).text.length)}function K(e,t){var r=e.ch
return null==r||r>t?H(e.line,t):r<0?H(e.line,0):e}function G(e,t){for(var r=[],n=0;n<t.length;n++)r[n]=V(e,t[n])
...
return r}function se(e){return le(e,!0)}function ue(e){return le(e,!1)}function ce(e,t,r,n,i){var o=M(e,t),a=_a&&o.markedSpans
...
if(i){var o=f(i,r)
o>-1&&(n[t]=i.slice(0,o).concat(i.slice(o+1)))}}}function Te(e,t){var r=Se(e,t)
if(r.length)for(var n=Array.prototype.slice.call(arguments,2),i=0;i<r.length;++i)r[i].apply(null,n)}function Me(e,t,r){return"string"==typeof t&&(t={type:t,preventDefault:function(){this.defaultPrevented=!0}}),Te(e,r||t.type,e,t),De(t)||t.codemirrorIgnore}function Ne(e){var t=e._handlers&&e._handlers.cursorActivity
if(t)for(var r=e.curOp.cursorActivityHandlers||(e.curOp.cursorActivityHandlers=[]),n=0;n<t.length;++n)-1==f(r,t[n])&&r.push(t[n])}function Ae(e,t){return Se(e,t).length>0}function Oe(e){e.prototype.on=function(e,t){Qa(this,e,t)},e.prototype.off=function(e,t){Le(this,e,t)}}function We(e){e.preventDefault?e.preventDefault():e.returnValue=!1}function ze(e){e.stopPropagation?e.stopPropagation():e.cancelBubble=!0}function De(e){return null!=e.defaultPrevented?e.defaultPrevented:0==e.returnValue}function Pe(e){We(e),ze(e)}function He(e){return e.target||e.srcElement}function Ee(e){var t=e.which
return null==t&&(1&e.button?t=1:2&e.button?t=3:4&e.button&&(t=2)),Ma&&e.ctrlKey&&1==t&&(t=3),t}function Ie(e){if(null==Ia){var t=n("span","​")
...
r.state=!0,tt(e,t.text,l.mode,r,function(e,t){for(var r=s;u<e;){var n=i[s]
...
return{styles:i,classes:o.bgClass||o.textClass?o:null}}function _e(e,t,r){if(!t.styles||t.styles[0]!=e.state.modeGen){var n=Xe(e,W(t)),i=t.text.length>e.options.maxHighlightLength&&Ge(e.doc.mode,n.state),o=$e(e,t,n)
...
var o=rt(e,t,r),a=o>n.first&&M(n,o-1).stateAfter,l=a?ul.fromSaved(n,a,o):new ul(n,qe(n.mode),o)
...
var o=e.token(t,r)
if(t.pos>t.start)return o}throw new Error("Mode "+e.name+" failed to advance stream.")}function Je(e,t,r,n){var i,o,a=e.doc,l=a.mode,s=M(a,(t=V(a,t)).line),u=Xe(e,t.line,r),c=new ll(s.text,e.options.tabSize,u)
...
var s=M(o,l-1),u=s.stateAfter
if(u&&(!r||l+(u instanceof sl?u.lookAhead:0)<=o.modeFrontier))return l
var c=d(s.text,null,e.options.tabSize);(null==i||n>c)&&(i=l-1,n=c)}return i}function nt(e,t){if(e.modeFrontier=Math.min(e.modeFrontier,t),!(e.highlightFrontier<t-10)){for(var r=e.first,n=t-1;n>r;n--){var i=M(e,n).stateAfter
...
break}p=T,c=""}m=i.slice(o,o=r[g++]),a=at(r[g++],t.cm.options)}}else for(var N=1;N<r.length;N+=2)t.addToken(t,i.slice(o,o=r[N]),at(r[N+1],t.cm.options))}function pt(e,t,r){this.line=t,this.rest=he(t),this.size=this.rest?W(g(this.rest))-r+1:1,this.node=this.text=null,this.hidden=me(e,t)}function gt(e,t,r){for(var n,i=[],o=t;o<r;o=n){var a=new pt(e.doc,M(e.doc,o),o)
...
t.text==t.node&&(t.node=n.pre),t.text.parentNode.replaceChild(n.pre,t.text),t.text=n.pre,n.bgClass!=t.bgClass||n.textClass!=t.textClass?(t.bgClass=n.bgClass,t.textClass=n.textClass,Tt(e,t)):r&&(t.text.className=r)}function Tt(e,t){Ct(e,t),t.line.wrapClass?kt(t).className=t.line.wrapClass:t.node!=t.text&&(t.node.className="")
var r=t.textClass?t.textClass+" "+(t.line.textClass||""):t.line.textClass
t.text.className=r||""}function Mt(e,t,r,i){if(t.gutter&&(t.node.removeChild(t.gutter),t.gutter=null),t.gutterBackground&&(t.node.removeChild(t.gutterBackground),t.gutterBackground=null),t.line.gutterClass){var o=kt(t)
...
if(e.display.input.setUneditable(s),l.insertBefore(s,t.text),t.line.gutterClass&&(s.className+=" "+t.line.gutterClass),!e.options.lineNumbers||a&&a["CodeMirror-linenumbers"]||(t.lineNumber=s.appendChild(n("div",P(e.options,r),"CodeMirror-linenumber CodeMirror-gutter-elt","left: "+i.gutterLeft["CodeMirror-linenumbers"]+"px; width: "+e.display.lineNumInnerWidth+"px"))),a)for(var u=0;u<e.options.gutters.length;++u){var c=e.options.gutters[u],d=a.hasOwnProperty(c)&&a[c]
...
n||(n="local")
var a=ye(t)
if("local"==n?a+=Ht(e.display):a-=e.display.viewOffset,"page"==n||"window"==n){var l=e.display.lineSpace.getBoundingClientRect()
...
return{left:n-a.left,top:i-a.top}}function ar(e,t,r,n,i){return n||(n=M(e.doc,t.line)),ir(e,n,Gt(e,n,t.ch,i),r)}function lr(e,t,r,n,i,o){function a(t,a){var l=$t(e,i,t,a?"right":"left",o)
return a?l.left=l.right:l.right=l.left,ir(e,n,l,r)}function l(e,t,r){var n=1==s[t].level
return a(r?e-1:e,n!=r)}n=n||M(e.doc,t.line),i||(i=qt(e,n))
...
var n=M(e.doc,t.line),i=ye(n)+Ht(e.display)
return{left:r,right:r,top:i,bottom:i+n.height}}function ur(e,t,r,n,i){var o=H(e,t,r)
...
t<0&&(t=0)
for(var a=M(n,i);;){var l=pr(e,a,i,t,r),s=ue(a),u=s&&s.find(0,!0)
...
return hr(lr(e,H(r,u?s.to:s.from,u?"before":"after"),"line",t,n),o,a,!0)},0,i.length-1),s=i[l]
if(l>0){var u=1!=s.level,c=lr(e,H(r,u?s.from:s.to,u?"after":"before"),"line",t,n)
hr(c,o,a,!0)&&c.top>a&&(s=i[l-1])}return s}function mr(e,t,r,n,i,o,a){var l=dr(e,t,n,a),s=l.begin,u=l.end;/\s/.test(t.text.charAt(u-1))&&u--
...
if(!r&&"true"==He(t).getAttribute("cm-not-content"))return null
var o,a,l=i.lineSpace.getBoundingClientRect()
try{o=t.clientX-l.left,a=t.clientY-l.top}catch(t){return null}var s,u=cr(e,o,a)
if(n&&1==u.xRel&&(s=M(e.doc,u.line).text).length==u.ch){var c=d(s,s.length,e.options.tabSize)-s.length
u=H(u.line,Math.max(0,Math.round((o-It(e.display).left)/yr(e.display))-c))}return u}function Sr(e,t){if(t>=e.display.viewTo)return null
if((t-=e.display.viewFrom)<0)return null
for(var r=e.display.view,n=0;n<r.length;n++)if((t-=r[n].size)<0)return n}function Lr(e){e.display.input.showSelection(e.display.input.prepareSelection())}function Tr(e,t){void 0===t&&(t=!0)
...
if(!(l.from().line>=e.display.viewTo||l.to().line<e.display.viewFrom)){var s=l.empty();(s||e.options.showCursorWhenSelecting)&&Mr(e,l.head,i),s||Ar(e,l,o)}}return n}function Mr(e,t,r){var i=lr(e,t,"div",null,null,!e.options.singleCursorHeightPerLine),o=r.appendChild(n("div"," ","CodeMirror-cursor"))
...
a.style.display="",a.style.left=i.other.left+"px",a.style.top=i.other.top+"px",a.style.height=.85*(i.other.bottom-i.other.top)+"px"}}function Nr(e,t){return e.top-t.top||e.left-t.left}function Ar(e,t,r){function i(e,t,r,i){t<0&&(t=0),t=Math.round(t),i=Math.round(i),s.appendChild(n("div",null,"CodeMirror-selected","position: absolute; left: "+e+"px;\n                             top: "+t+"px; width: "+(null==r?d-e:r)+"px;\n                             height: "+(i-t)+"px"))}function o(t,r,n){function o(r,n){return ar(e,H(t,r),"div",h,n)}function a(t,r,n){var i=fr(e,h,null,t),a="ltr"==r==("after"==n)?"left":"right"
return o("after"==n?i.begin:i.end-(/\s/.test(h.text.charAt(i.end-1))?2:1),a)[a]}var s,u,h=M(l,t),p=h.text.length,g=Ce(h,l.direction)
return xe(g,r||0,null==n?p:n,function(e,t,l,h){var m="ltr"==l,v=o(e,m?"left":"right"),y=o(t-1,m?"right":"left"),b=null==r&&0==e,w=null==n&&t==p,x=0==h,k=!g||h==g.length-1
if(y.top-v.top<=3){var C=(f?b:w)&&x,S=(f?w:b)&&k,L=C?c:(m?v:y).left,T=S?d:(m?y:v).right
i(L,v.top,T-L,v.bottom)}else{var M,N,A,O
m?(M=f&&b&&x?c:v.left,N=f?d:a(e,l,"before"),A=f?c:a(t,l,"after"),O=f&&w&&k?d:y.right):(M=f?a(e,l,"before"):c,N=!f&&b&&x?d:v.right,A=!f&&w&&k?c:y.left,O=f?a(t,l,"after"):d),i(M,v.top,N-M,v.bottom),v.bottom<y.top&&i(c,v.bottom,null,y.top),i(A,y.top,O-A,y.bottom)}(!s||Nr(v,s)<0)&&(s=v),Nr(y,s)<0&&(s=y),(!u||Nr(v,u)<0)&&(u=v),Nr(y,u)<0&&(u=y)}),{start:s,end:u}}var a=e.display,l=e.doc,s=document.createDocumentFragment(),u=It(e.display),c=u.left,d=Math.max(a.sizerWidth,Rt(e)-a.sizer.offsetLeft)-u.right,f="ltr"==l.direction,h=t.from(),p=t.to()
if(h.line==p.line)o(h.line,h.ch,p.ch)
else{var g=M(l,h.line),m=M(l,p.line),v=de(g)==de(m),y=o(h.line,h.ch,v?g.text.length+1:null).end,b=o(p.line,v?0:null,p.ch).start
v&&(y.top<b.top-2?(i(y.right,y.top,null,y.bottom),i(c,b.top,b.left,b.bottom)):i(y.right,y.top,b.left-y.right,y.bottom)),y.bottom<b.top&&i(c,y.bottom,null,b.top)}r.appendChild(s)}function Or(e){if(e.state.focused){var t=e.display
clearInterval(t.blinker)
var r=!0
t.cursorDiv.style.visibility="",e.options.cursorBlinkRate>0?t.blinker=setInterval(function(){return t.cursorDiv.style.visibility=(r=!r)?"":"hidden"},e.options.cursorBlinkRate):e.options.cursorBlinkRate<0&&(t.cursorDiv.style.visibility="hidden")}}function Wr(e){e.state.focused||(e.display.input.focus(),Dr(e))}function zr(e){e.state.delayingBlurEvent=!0,setTimeout(function(){e.state.delayingBlurEvent&&(e.state.delayingBlurEvent=!1,Pr(e))},100)}function Dr(e,t){e.state.delayingBlurEvent&&(e.state.delayingBlurEvent=!1),"nocursor"!=e.options.readOnly&&(e.state.focused||(Te(e,"focus",e,t),e.state.focused=!0,l(e.display.wrapper,"CodeMirror-focused"),e.curOp||e.display.selForContextMenu==e.doc.sel||(e.display.input.reset(),va&&setTimeout(function(){return e.display.input.reset(!0)},20)),e.display.input.receivedFocus()),Or(e))}function Pr(e,t){e.state.delayingBlurEvent||(e.state.focused&&(Te(e,"blur",e,t),e.state.focused=!1,Pa(e.display.wrapper,"CodeMirror-focused")),clearInterval(e.display.blinker),setTimeout(function(){e.state.focused||(e.display.shift=!1)},150))}function Hr(e){for(var t=e.display,r=t.lineDiv.offsetTop,n=0;n<t.view.length;n++){var i=t.view[n],o=void 0
...
l<o?(o=l,a=z(t,ye(M(t,l))+e.wrapper.clientHeight)):Math.min(s,t.lastLine())>=a&&(o=z(t,ye(M(t,s))-e.wrapper.clientHeight),a=s)}return{from:o,to:Math.max(a,o+1)}}function Fr(e){var t=e.display,r=t.view
...
var t=e.doc,r=P(e.options,t.first+t.size-1),i=e.display
...
var i
e.options.lineWrapping||t!=r||(r="before"==(t=t.ch?H(t.line,"before"==t.sticky?t.ch-1:t.ch,"after"):t).sticky?H(t.line,t.ch+1,"before"):t)
...
tn(e,t)
for(var i=0;i<4&&r!=e.display.barWidth||n!=e.display.barHeight;i++)r!=e.display.barWidth&&e.options.lineWrapping&&Hr(e),tn(e,Jr(e)),r=e.display.barWidth,n=e.display.barHeight}function tn(e,t){var r=e.display,n=r.scrollbars.update(t)
r.sizer.style.paddingRight=(r.barWidth=n.right)+"px",r.sizer.style.paddingBottom=(r.barHeight=n.bottom)+"px",r.heightForcer.style.borderBottom=n.bottom+"px solid transparent",n.right&&n.bottom?(r.scrollbarFiller.style.display="block",r.scrollbarFiller.style.height=n.bottom+"px",r.scrollbarFiller.style.width=n.right+"px"):r.scrollbarFiller.style.display="",n.bottom&&e.options.coverGutterNextToScrollbar&&e.options.fixedGutter?(r.gutterFiller.style.display="block",r.gutterFiller.style.height=n.bottom+"px",r.gutterFiller.style.width=t.gutterWidth+"px"):r.gutterFiller.style.display=""}function rn(e){e.display.scrollbars&&(e.display.scrollbars.clear(),e.display.scrollbars.addClass&&Pa(e.display.wrapper,e.display.scrollbars.addClass)),e.display.scrollbars=new wl[e.options.scrollbarStyle](function(t){e.display.wrapper.insertBefore(t,e.display.scrollbarFiller),Qa(t,"mousedown",function(){e.state.focused&&setTimeout(function(){return e.display.input.focus()},0)}),t.setAttribute("cm-not-content","true")},function(t,r){"horizontal"==r?Qr(e,t):Yr(e,t)},e),e.display.scrollbars.addClass&&l(e.display.wrapper,e.display.scrollbars.addClass)}function nn(e){e.curOp={cm:e,viewChanged:!1,startHeight:e.doc.height,forceUpdate:!1,updateInput:null,typing:!1,changeObjs:null,cursorActivityHandlers:null,cursorActivityCalled:0,selectionChanged:!1,updateMaxLine:!1,scrollLeft:null,scrollTop:null,scrollToPos:null,focus:!1,id:++xl},mt(e.curOp)}function on(e){yt(e.curOp,function(e){for(var t=0;t<e.ops.length;t++)e.ops[t].cm.curOp=null
...
if(i)for(var a=0;a<i.length;++a)i[a].lines.length||Te(i[a],"hide")
if(o)for(var l=0;l<o.length;++l)o[l].lines.length&&Te(o[l],"unhide")
r.wrapper.offsetHeight&&(n.scrollTop=t.display.scroller.scrollTop),e.changeObjs&&Te(t,"changes",t,e.changeObjs),e.update&&e.update.finish()}function fn(e,t){if(e.curOp)return t()
nn(e)
...
r.setEnd(e.anchorNode,e.anchorOffset),r.collapse(!1),t.removeAllRanges(),t.addRange(r),t.extend(e.focusNode,e.focusOffset)}}function Mn(e,r){var n=e.display,i=e.doc
...
if(Mn(e,r)){Hr(e),Nn(e,r)
var n=Jr(e)
Lr(e),en(e,n),zn(e,n),r.finish()}}function On(e,r,n){function i(t){var r=t.nextSibling
return va&&Ma&&e.display.currentWheelTarget==t?t.style.display="none":t.parentNode.removeChild(t),r}for(var o=e.display,a=e.options.lineNumbers,l=o.lineDiv,s=l.firstChild,u=o.view,c=o.viewFrom,d=0;d<u.length;d++){var h=u[d]
if(h.hidden);else if(h.node&&h.node.parentNode==l){for(;s!=h.node;)s=i(s)
var p=a&&null!=r&&r<=c&&h.lineNumber
h.changes&&(f(h.changes,"gutter")>-1&&(p=!1),xt(e,h,c,n)),p&&(t(h.lineNumber),h.lineNumber.appendChild(document.createTextNode(P(e.options,c)))),s=h.node.nextSibling}else{var g=At(e,h,c,n)
...
"CodeMirror-linenumbers"==a&&(e.display.lineGutter=l,l.style.width=(e.display.lineNumWidth||1)+"px")}r.style.display=o?"":"none",Wn(e)}function Pn(e){var t=f(e.gutters,"CodeMirror-linenumbers");-1==t&&e.lineNumbers?e.gutters=e.gutters.concat(["CodeMirror-linenumbers"]):t>-1&&!e.lineNumbers&&(e.gutters=e.gutters.slice(0),e.gutters.splice(t,1))}function Hn(e){var t=e.wheelDeltaX,r=e.wheelDeltaY
return null==t&&e.detail&&e.axis==e.HORIZONTAL_AXIS&&(t=e.detail),null==r&&e.detail&&e.axis==e.VERTICAL_AXIS?r=e.detail:null==r&&(r=e.wheelDelta),{x:t,y:r}}function En(e){var t=Hn(e)
return t.x*=Sl,t.y*=Sl,t}function In(e,t){var r=Hn(t),n=r.x,i=r.y,o=e.display,a=o.scroller,l=a.scrollWidth>a.clientWidth,s=a.scrollHeight>a.clientHeight
if(n&&l||i&&s){if(i&&Ma&&va)e:for(var u=t.target,c=o.view;u!=a;u=u.parentNode)for(var d=0;d<c.length;d++)if(c[d].node==u){e.display.currentWheelTarget=u
...
n<=t&&--t,e.splice(--n,2,new Tl(s?l:a,s?a:l))}}return new Ll(e,t)}function Rn(e,t){return new Ll([new Tl(e,t||e)],0)}function Bn(e){return e.text?H(e.from.line+e.text.length-1,g(e.text).length+(1==e.text.length?e.from.ch:0)):e.to}function jn(e,t){if(E(e,t.from)<0)return e
if(E(e,t.to)<=0)return Bn(t)
var r=e.line+t.text.length-(t.to.line-t.from.line)-1,n=e.ch
return e.line==t.to.line&&(n+=Bn(t).ch-t.to.ch),H(r,n)}function Vn(e,t){for(var r=[],n=0;n<e.sel.ranges.length;n++){var i=e.sel.ranges[n]
r.push(new Tl(jn(i.anchor,t),jn(i.head,t)))}return Fn(r,e.sel.primIndex)}function Kn(e,t,r){return e.line==t.line?H(r.line,e.ch-t.ch+r.ch):H(r.line+(e.line-t.line),e.ch)}function Gn(e,t,r){for(var n=[],i=H(e.first,0),o=i,a=0;a<t.length;a++){var l=t[a],s=Kn(l.from,i,o),u=Kn(Bn(l),i,o)
if(i=l.to,o=u,"around"==r){var c=e.sel.ranges[a],d=E(c.head,c.anchor)<0
n[a]=new Tl(d?u:s,d?s:u)}else n[a]=new Tl(s,s)}return new Ll(n,e.sel.primIndex)}function Un(e){e.doc.mode=Ve(e.options,e.doc.modeOption),qn(e)}function qn(e){e.doc.iter(function(e){e.stateAfter&&(e.stateAfter=null),e.styles&&(e.styles=null)}),e.doc.modeFrontier=e.doc.highlightFrontier=e.doc.first,kn(e,100),e.state.modeGen++,e.curOp&&mn(e)}function $n(e,t){return 0==t.from.ch&&0==t.to.ch&&""==g(t.text)&&(!e.cm||e.cm.options.wholeLineUpdateBefore)}function _n(e,t,r,n){function i(e){return r?r[e]:null}function o(e,r,i){it(e,r,i,n),bt(e,"change",e,t)}function a(e,t){for(var r=[],o=e;o<t;++o)r.push(new dl(u[o],i(o),n))
return r}var l=t.from,s=t.to,u=t.text,c=M(e,l.line),d=M(e,s.line),f=g(u),h=i(u.length-1),p=s.line-l.line
...
e.doc=t,t.cm=e,kr(e),Un(e),Zn(e),e.options.lineWrapping||we(e),e.options.mode=t.modeOption,mn(e)}function Zn(e){("rtl"==e.doc.direction?l:Pa)(e.display.lineDiv,"CodeMirror-rtl")}function Qn(e){fn(e,function(){Zn(e),mn(e)})}function Jn(e){this.done=[],this.undone=[],this.undoDepth=1/0,this.lastModTime=this.lastSelTime=0,this.lastOp=this.lastSelOp=null,this.lastOrigin=this.lastSelOrigin=null,this.generation=this.maxGeneration=e||1}function ei(e,t){var r={from:F(t.from),to:Bn(t),text:N(e,t.from,t.to)}
...
for(s&&s.ranges||ai(e.sel,i.done),o={changes:[ei(e,t)],generation:i.generation},i.done.push(o);i.done.length>i.undoDepth;)i.done.shift(),i.done[0].ranges||i.done.shift()}i.done.push(r),i.generation=++i.maxGeneration,i.lastModTime=i.lastSelTime=l,i.lastOp=i.lastSelOp=n,i.lastOrigin=i.lastSelOrigin=t.origin,a||Te(e,"historyAdded")}function ii(e,t,r,n){var i=t.charAt(0)
...
if(r){var o=E(t,i)<0
o!=E(r,i)<0?(i=t,t=r):o!=E(t,r)<0&&(t=r)}return new Tl(i,t)}return new Tl(r||t,t)}function hi(e,t,r,n,i){null==i&&(i=e.cm&&(e.cm.display.shift||e.extend)),bi(e,new Ll([fi(e.sel.primary(),t,r,i)],0),n)}function pi(e,t,r){for(var n=[],i=e.cm&&(e.cm.display.shift||e.extend),o=0;o<e.sel.ranges.length;o++)n[o]=fi(e.sel.ranges[o],t[o],null,i)
...
this.ranges=[]
for(var n=0;n<t.length;n++)r.ranges[n]=new Tl(V(e,t[n].anchor),V(e,t[n].head))},origin:r&&r.origin}
return Te(e,"beforeSelectionChange",e,n),e.cm&&Te(e.cm,"beforeSelectionChange",e.cm,n),n.ranges!=t.ranges?Fn(n.ranges,n.ranges.length-1):t}function yi(e,t,r){var n=e.history.done,i=g(n)
i&&i.ranges?(n[n.length-1]=t,wi(e,t,r)):bi(e,t,r)}function bi(e,t,r){wi(e,t,r),oi(e,e.sel,e.cm?e.cm.curOp.id:NaN,r)}function wi(e,t,r){(Ae(e,"beforeSelectionChange")||e.cm&&Ae(e.cm,"beforeSelectionChange"))&&(t=vi(e,t,r)),xi(e,Ci(e,t,r&&r.bias||(E(t.primary().head,e.sel.primary().head)<0?-1:1),!0)),r&&!1===r.scroll||!e.cm||Ur(e.cm)}function xi(e,t){t.equals(e.sel)||(e.sel=t,e.cm&&(e.cm.curOp.updateInput=e.cm.curOp.selectionChanged=!0,Ne(e.cm)),bt(e,"cursorActivity",e))}function ki(e){xi(e,Ci(e,e.sel,null,!1))}function Ci(e,t,r,n){for(var i,o=0;o<t.ranges.length;o++){var a=t.ranges[o],l=t.ranges.length==e.sel.ranges.length&&e.sel.ranges[o],s=Li(e,a.anchor,l&&l.anchor,r,n),u=Li(e,a.head,l&&l.head,r,n);(i||s!=a.anchor||u!=a.head)&&(i||(i=t.ranges.slice(0,o)),i[o]=new Tl(s,u))}return i?Fn(i,t.primIndex):t}function Si(e,t,r,n,i){var o=M(e,t.line)
if(o.markedSpans)for(var a=0;a<o.markedSpans.length;++a){var l=o.markedSpans[a],s=l.marker
if((null==l.from||(s.inclusiveLeft?l.from<=t.ch:l.from<t.ch))&&(null==l.to||(s.inclusiveRight?l.to>=t.ch:l.to>t.ch))){if(i&&(Te(s,"beforeCursorEnter"),s.explicitlyCleared)){if(o.markedSpans){--a
continue}break}if(!s.atomic)continue
if(r){var u=s.find(n<0?1:-1),c=void 0
if((n<0?s.inclusiveRight:s.inclusiveLeft)&&(u=Ti(e,u,-n,u&&u.line==t.line?o:null)),u&&u.line==t.line&&(c=E(u,r))&&(n<0?c<0:c>0))return Si(e,u,t,n,i)}var d=s.find(n<0?-1:1)
return(n<0?s.inclusiveLeft:s.inclusiveRight)&&(d=Ti(e,d,n,d.line==t.line?o:null)),d?Si(e,d,t,n,i):null}}return t}function Li(e,t,r,n,i){var o=n||1
return Si(e,t,r,o,i)||!i&&Si(e,t,r,o,!0)||Si(e,t,r,-o,i)||!i&&Si(e,t,r,-o,!0)||(e.cantEdit=!0,H(e.first,0))}function Ti(e,t,r,n){return r<0&&0==t.ch?t.line>e.first?V(e,H(t.line-1)):null:r>0&&t.ch==(n||M(e,t.line)).text.length?t.line<e.first+e.size-1?H(t.line+1,0):null:new H(t.line,t.ch+r)}function Mi(e){e.setSelection(H(e.firstLine(),0),H(e.lastLine()),ja)}function Ni(e,t,r){var n={canceled:!1,from:t.from,to:t.to,text:t.text,origin:t.origin,cancel:function(){return n.canceled=!0}}
return r&&(n.update=function(t,r,i,o){t&&(n.from=V(e,t)),r&&(n.to=V(e,r)),i&&(n.text=i),void 0!==o&&(n.origin=o)}),Te(e,"beforeChange",e,n),e.cm&&Te(e.cm,"beforeChange",e.cm,n),n.canceled?null:{from:n.from,to:n.to,text:n.text,origin:n.origin}}function Ai(e,t,r){if(e.cm){if(!e.cm.curOp)return hn(e.cm,Ai)(e,t,r)
...
if(h)return h.v}}}}function zi(e,t){if(0!=t&&(e.first+=t,e.sel=new Ll(m(e.sel.ranges,function(e){return new Tl(H(e.anchor.line+t,e.anchor.ch),H(e.head.line+t,e.head.ch))}),e.sel.primIndex),e.cm)){mn(e.cm,e.first,e.first-t,t)
...
zi(e,i),t={from:H(e.first,0),to:H(t.to.line+i,t.to.ch),text:[g(t.text)],origin:t.origin}}var o=e.lastLine()
t.to.line>o&&(t={from:t.from,to:H(o,M(e,o).text.length),text:[t.text[0]],origin:t.origin}),t.removed=N(e,t.from,t.to),r||(r=Vn(e,t)),e.cm?Pi(e.cm,t,n):_n(e,t,n),wi(e,r,ja)}}function Pi(e,t,r){var n=e.doc,i=e.display,o=t.from,a=t.to,l=!1,s=o.line
e.options.lineWrapping||(s=W(de(M(n,o.line))),n.iter(s,a.line+1,function(e){if(e==i.maxLine)return l=!0,!0})),n.sel.contains(t.from,t.to)>-1&&Ne(e),_n(n,t,r,xr(e)),e.options.lineWrapping||(n.iter(s,o.line+t.text.length,function(e){var t=be(e)
...
d&&bt(e,"change",e,f),c&&(e.curOp.changeObjs||(e.curOp.changeObjs=[])).push(f)}e.display.selForContextMenu=null}function Hi(e,t,r,n,i){if(n||(n=r),E(n,r)<0){var o
...
if(r<u.from.line)u.from=H(u.from.line+n,u.from.ch),u.to=H(u.to.line+n,u.to.ch)
...
return"number"==typeof t?o=M(e,j(e,t)):i=W(t),null==i?null:(n(o,i)&&e.cm&&vn(e.cm,i,r),o)}function Bi(e){var t=this
...
r+=o.chunkSize(),n+=o.height,o.parent=t}this.size=r,this.height=n,this.parent=null}function Vi(e,t,r){ye(t)<(e.curOp&&e.curOp.scrollTop||e.doc.scrollTop)&&Gr(e,r)}function Ki(e,t,r,n){var i=new Ml(e,r,n),o=e.cm
...
a=g(o)}),new Ol(o,a)}function qi(e){return e.findMarks(H(e.first,0),e.clipPos(H(e.lastLine())),function(e){return e.parent})}function $i(e,t){for(var r=0;r<t.length;r++){var n=t[r],i=n.find(),o=e.clipPos(i.from),a=e.clipPos(i.to)
...
if(Qi(t),!Me(t,e)&&!Pt(t.display,e)){We(e),ga&&(Dl=+new Date)
...
if(u){var c
if(t.state.draggingText&&!t.state.draggingText.copy&&(c=t.listSelections()),wi(t.doc,Rn(r,r)),c)for(var d=0;d<c.length;++d)Hi(t.doc,"",c[d].anchor,c[d].head,"drag")
t.replaceSelection(u,"around","paste"),t.display.input.focus()}}catch(e){}}}}function Yi(e,t){if(ga&&(!e.state.draggingText||+new Date-Dl<100))Pe(t)
else if(!Me(e,t)&&!Pt(e.display,t)&&(t.dataTransfer.setData("Text",e.getSelection()),t.dataTransfer.effectAllowed="copyMove",t.dataTransfer.setDragImage&&!xa)){var r=n("img",null,null,"position: fixed; left: 0; top: 0;")
...
n&&e(n)}}function eo(){Pl||(to(),Pl=!0)}function to(){var e
Qa(window,"resize",function(){null==e&&(e=setTimeout(function(){e=null,Ji(ro)},100))}),Qa(window,"blur",function(){return Ji(Pr)})}function ro(e){var t=e.display
...
if(a)return a}}}function ao(e){var t="string"==typeof e?e:Hl[e.keyCode]
...
break}}n.push(o)}fn(e,function(){for(var t=n.length-1;t>=0;t--)Hi(e.doc,"",n[t].from,n[t].to,"+delete")
Ur(e)})}function fo(e,t,r){var n=S(e.text,t+r,r)
return n<0||n>e.text.length?null:n}function ho(e,t,r){var n=fo(e,t.ch,r)
return null==n?null:new H(t.line,n,r<0?"after":"before")}function po(e,t,r,n,i){if(e){var o=Ce(r,t.doc.direction)
if(o){var a,l=i<0?g(o):o[0],s=i<0==(1==l.level)?"after":"before"
if(l.level>0||"rtl"==t.doc.direction){var u=qt(t,r)
...
return new H(n,a,s)}}return new H(n,i<0?r.text.length:0,i<0?"before":"after")}function go(e,t,r,n){var i=Ce(t,e.doc.direction)
...
var l,s=function(e,r){return fo(t,e instanceof H?e.ch:e,r)},u=function(r){return e.options.lineWrapping?(l=l||qt(e,t),fr(e,t,l,r)):{begin:0,end:t.text.length}},c=u("before"==r.sticky?s(r,-1):r.ch)
...
return new H(r.line,f,h)}}var p=function(e,t,n){for(var o=function(e,t){return t?new H(r.line,s(e,1),"before"):new H(r.line,e,"after")};e>=0&&e<i.length;e+=t){var a=i[e],l=t>0==(1!=a.level),u=l?n.begin:s(n.end,-1)
...
return null==m||n>0&&m==t.text.length||!(g=p(n>0?0:i.length-1,n,u(m)))?null:g}function mo(e,t){var r=M(e.doc,t),n=de(r)
return n!=r&&(t=W(n)),po(!0,e,n,t,1)}function vo(e,t){var r=M(e.doc,t),n=fe(r)
return n!=r&&(t=W(n)),po(!0,e,r,t,-1)}function yo(e,t){var r=mo(e,t.line),n=M(e.doc,r.line),i=Ce(n,e.doc.direction)
if(!i||0==i[0].level){var o=Math.max(0,n.text.search(/\S/)),a=t.line==r.line&&t.ch<=o&&t.ch
return H(r.line,a?0:o,r.sticky)}return r}function bo(e,t,r){if("string"==typeof t&&!(t=Bl[t]))return!1
...
if(t.curOp.focus=a(),!Me(t,e)){ga&&ma<11&&27==e.keyCode&&(e.returnValue=!1)
var r=e.keyCode
t.display.shift=16==r||e.shiftKey
var n=ko(t,e)
wa&&(Vl=n?r:null,!n&&88==r&&!rl&&(Ma?e.metaKey:e.ctrlKey)&&t.replaceSelection("",null,"cut")),18!=r||/\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className)||Lo(t)}}function Lo(e){function t(e){18!=e.keyCode&&e.altKey||(Pa(r,"CodeMirror-crosshair"),Le(document,"keyup",t),Le(document,"mouseover",t))}var r=e.display.lineDiv
l(r,"CodeMirror-crosshair"),Qa(document,"keyup",t),Qa(document,"mouseover",t)}function To(e){16==e.keyCode&&(this.doc.sel.shift=!1),Me(this,e)}function Mo(e){var t=this
if(!(Pt(t.display,e)||Me(t,e)||e.ctrlKey&&!e.altKey||Ma&&e.metaKey)){var r=e.keyCode,n=e.charCode
...
if(!(Me(t,e)||r.activeTouch&&r.input.supportsTouch()))if(r.input.ensurePolled(),r.shift=e.shiftKey,Pt(r,e))va||(r.scroller.draggable=!1,setTimeout(function(){return r.scroller.draggable=!0},100))
else if(!Fo(t,e)){var n=Cr(t,e),i=Ee(e),o=n?No(n,i):"single"
window.focus(),1==i&&t.state.selectingText&&t.state.selectingText(e),n&&Oo(t,i,n,o,e)||(1==i?n?zo(t,n,o,e):He(e)==r.scroller&&We(e):2==i?(n&&hi(t.doc,n),setTimeout(function(){return r.input.focus()},20)):3==i&&(Da?Ro(t,e):zr(t)))}}function Oo(e,t,r,n,i){var o="Click"
...
i.unit=o?"rectangle":"single"==t?"char":"double"==t?"word":"line"}return(null==i.extend||e.doc.extend)&&(i.extend=e.doc.extend||r.shiftKey),null==i.addNew&&(i.addNew=Ma?r.metaKey:r.ctrlKey),null==i.moveOnDrag&&(i.moveOnDrag=!(Ma?r.altKey:r.ctrlKey)),i}function zo(e,t,r,n){ga?setTimeout(u(Wr,e),0):e.curOp.focus=a()
...
va&&(i.scroller.draggable=!0),e.state.draggingText=a,a.copy=!n.moveOnDrag,i.scroller.dragDrop&&i.scroller.dragDrop(),Qa(document,"mouseup",a),Qa(document,"mousemove",l),Qa(i.scroller,"dragstart",s),Qa(i.scroller,"drop",a),zr(e),setTimeout(function(){return i.input.focus()},20)}function Po(e,t,r){if("char"==r)return new Tl(t,t)
if("word"==r)return e.findWordAt(t)
if("line"==r)return new Tl(H(t.line,0),V(e.doc,H(t.line+1,0)))
var n=r(e,t)
return new Tl(n.from,n.to)}function Ho(e,t,r,n){function i(t){if(0!=E(v,t))if(v=t,"rectangle"==n.unit){for(var i=[],o=e.options.tabSize,a=d(M(u,r.line).text,r.ch,o),l=d(M(u,t.line).text,t.ch,o),s=Math.min(a,l),g=Math.max(a,l),m=Math.min(r.line,t.line),y=Math.min(e.lastLine(),Math.max(r.line,t.line));m<=y;m++){var b=M(u,m).text,w=h(b,s,o)
s==g?i.push(new Tl(H(m,w),H(m,w))):b.length>w&&i.push(new Tl(H(m,w),H(m,h(b,g,o))))}i.length||i.push(new Tl(r,r)),bi(u,Fn(p.ranges.slice(0,f).concat(i),f),{origin:"*mouse",scroll:!1}),e.scrollIntoView(t)}else{var x,k=c,C=Po(e,t,n.unit),S=k.anchor
E(C.anchor,S)>0?(x=C.head,S=B(k.from(),C.anchor)):(x=C.anchor,S=R(k.to(),C.head))
var L=p.ranges.slice(0)
L[f]=Eo(e,new Tl(V(u,S),x)),bi(u,Fn(L,f),Va)}}function o(t){var r=++b,l=Cr(e,t,!0,"rectangle"==n.unit)
...
if(n.addNew&&!n.extend?(f=u.sel.contains(r),c=f>-1?g[f]:new Tl(r,r)):(c=u.sel.primary(),f=u.sel.primIndex),"rectangle"==n.unit)n.addNew||(c=new Tl(r,r)),r=Cr(e,t,!0,!0),f=-1
else{var m=Po(e,r,n.unit)
...
e.state.selectingText=x,Qa(document,"mousemove",w),Qa(document,"mouseup",x)}function Eo(e,t){var r=t.anchor,n=t.head,i=M(e.doc,r.line)
...
return r.ch==p&&r.sticky==g?t:new Tl(new H(r.line,p,g),n)}function Io(e,t,r,n){var i,o
...
if(u&&u.getBoundingClientRect().right>=i)return Te(e,r,e,z(e.doc,o),e.options.gutters[s],t),De(t)}}function Fo(e,t){return Io(e,t,"gutterClick",!0)}function Ro(e,t){Pt(e.display,t)||Bo(e,t)||Me(e,t,"contextmenu")||e.display.input.onContextMenu(t)}function Bo(e,t){return!!Ae(e,"gutterContextMenu")&&Io(e,t,"gutterContextMenu",!1)}function jo(e){e.display.wrapper.className=e.display.wrapper.className.replace(/\s*cm-s-\S+/g,"")+e.options.theme.replace(/(^|\s)\s*/g," cm-s-"),er(e)}function Vo(e){Dn(e),mn(e),Fr(e)}function Ko(e,t,r){if(!t!=!(r&&r!=ql)){var n=e.display.dragFunctions,i=t?Qa:Le
i(e.display.scroller,"dragstart",n.start),i(e.display.scroller,"dragenter",n.enter),i(e.display.scroller,"dragover",n.over),i(e.display.scroller,"dragleave",n.leave),i(e.display.scroller,"drop",n.drop)}}function Go(e){e.options.lineWrapping?(l(e.display.wrapper,"CodeMirror-wrap"),e.display.sizer.style.minWidth="",e.display.sizerWidth=null):(Pa(e.display.wrapper,"CodeMirror-wrap"),we(e)),kr(e),mn(e),er(e),setTimeout(function(){return en(e)},100)}function Uo(e,t){var r=this
if(!(this instanceof Uo))return new Uo(e,t)
this.options=t=t?c(t):{},c($l,t,!1),Pn(t)
var n=t.value
"string"==typeof n&&(n=new zl(n,t.mode,null,t.lineSeparator,t.direction)),this.doc=n
var i=new Uo.inputStyles[t.inputStyle](this),o=this.display=new T(e,n,i)
o.wrapper.CodeMirror=this,Dn(this),jo(this),t.lineWrapping&&(this.display.wrapper.className+=" CodeMirror-wrap"),rn(this),this.state={keyMaps:[],overlays:[],modeGen:0,overwrite:!1,delayingBlurEvent:!1,focused:!1,suppressEdits:!1,pasteIncoming:!1,cutIncoming:!1,selectingText:!1,draggingText:!1,highlight:new Ea,keySeq:null,specialChars:null},t.autofocus&&!Ta&&o.input.focus(),ga&&ma<11&&setTimeout(function(){return r.display.input.reset(!0)},20),qo(this),eo(),nn(this),this.curOp.forceUpdate=!0,Yn(this,n),t.autofocus&&!Ta||this.hasFocus()?setTimeout(u(Dr,this),20):Pr(this)
...
Qa(i.scroller,"mousedown",hn(e,Ao)),ga&&ma<11?Qa(i.scroller,"dblclick",hn(e,function(t){if(!Me(e,t)){var r=Cr(e,t)
if(r&&!Fo(e,t)&&!Pt(e.display,t)){We(t)
var n=e.findWordAt(r)
hi(e.doc,n.anchor,n.head)}}})):Qa(i.scroller,"dblclick",function(t){return Me(e,t)||We(t)}),Da||Qa(i.scroller,"contextmenu",function(t){return Ro(e,t)})
var o,a={end:0}
Qa(i.scroller,"touchstart",function(t){if(!Me(e,t)&&!r(t)&&!Fo(e,t)){i.input.ensurePolled(),clearTimeout(o)
var n=+new Date
...
if(o&&!Pt(i,r)&&null!=o.left&&!o.moved&&new Date-o.start<300){var a,l=e.coordsChar(i.activeTouch,"page")
a=!o.prev||n(o,o.prev)?new Tl(l,l):!o.prev.prev||n(o,o.prev.prev)?e.findWordAt(l):new Tl(H(l.line,0),V(e.doc,H(l.line+1,0))),e.setSelection(a.anchor,a.head),e.focus(),We(r)}t()}),Qa(i.scroller,"touchcancel",t),Qa(i.scroller,"scroll",function(){i.scroller.clientHeight&&(Yr(e,i.scroller.scrollTop),Qr(e,i.scroller.scrollLeft,!0),Te(e,"scroll",e))}),Qa(i.scroller,"mousewheel",function(t){return In(e,t)}),Qa(i.scroller,"DOMMouseScroll",function(t){return In(e,t)}),Qa(i.wrapper,"scroll",function(){return i.wrapper.scrollTop=i.wrapper.scrollLeft=0}),i.dragFunctions={enter:function(t){Me(e,t)||Pe(t)},over:function(t){Me(e,t)||(Zi(e,t),Pe(t))},start:function(t){return Yi(e,t)},drop:hn(e,Xi),leave:function(t){Me(e,t)||Qi(e)}}
var l=i.input.getField()
Qa(l,"keyup",function(t){return To.call(e,t)}),Qa(l,"keydown",hn(e,So)),Qa(l,"keypress",hn(e,Mo)),Qa(l,"focus",function(t){return Dr(e,t)}),Qa(l,"blur",function(t){return Pr(e,t)})}function $o(e,t,r,n){var i,o=e.doc
...
"prev"==r?u=t>o.first?d(M(o,t-1).text,null,a):0:"add"==r?u=s+e.options.indentUnit:"subtract"==r?u=s-e.options.indentUnit:"number"==typeof r&&(u=s+r),u=Math.max(0,u)
var f="",h=0
if(e.options.indentWithTabs)for(var g=Math.floor(u/a);g;--g)h+=a,f+="\t"
if(h<u&&(f+=p(u-h)),f!=c)return Hi(o,f,H(t,0),H(t,c.length),"+input"),l.stateAfter=null,!0
for(var m=0;m<o.sel.ranges.length;m++){var v=o.sel.ranges[m]
if(v.head.line==t&&v.head.ch<c.length){var y=H(t,c.length)
gi(o,m,new Tl(y,y))
...
f.empty()&&(r&&r>0?h=H(h.line,h.ch-r):e.state.overwrite&&!a?p=H(p.line,Math.min(M(o,p.line).text.length,p.ch+g(l).length)):Yl&&Yl.lineWise&&Yl.text.join("\n")==t&&(h=p=H(h.line,0))),c=e.curOp.updateInput
...
break}}else o.electricInput&&o.electricInput.test(M(e.doc,i.head.line).text.slice(0,i.head.ch))&&(a=$o(e,i.head.line,"smart"))
a&&bt(e,"electricInput",e,i.head.line)}}}function Qo(e){for(var t=[],r=[],n=0;n<e.doc.sel.ranges.length;n++){var i=e.doc.sel.ranges[n].head.line,o={anchor:H(i,0),head:H(i+1,0)}
...
return!(n<e.first||n>=e.first+e.size)&&(t=new H(n,t.ch,t.sticky),u=M(e,n))}function a(n){var a
if(null==(a=i?go(e.cm,u,t,r):ho(u,t,r))){if(n||!o())return!1
t=po(i,e.cm,u,t.line,r)}else t=a
return!0}var l=t,s=r,u=M(e,t.line)
if("char"==n)a()
...
var n=M(e.doc,t.line),i=Vt(r,n,t.line),o=Ce(n,e.doc.direction),a="left"
...
if(f){var h=e.findMarks(H(n,0),H(i+1,0),o(+f))
...
if(t==e.display.lineDiv){if(!(n=e.display.lineDiv.childNodes[r]))return oa(e.clipPos(H(e.display.viewTo-1)),!0)
...
return(n<0||l!=t)&&(u=o[a+(n?1:0)]),H(s,u)}}}var i=e.text.firstChild,a=!1
if(!t||!o(i,t))return oa(H(W(e.line),0),!0)
if(t==i&&(a=!0,t=i.childNodes[r],r=0,!t)){var l=e.rest?g(e.rest):e.line
return oa(H(W(l),l.text.length),a)}var s=3==t.nodeType?t:null,u=t
...
if(f)return oa(f,a)
for(var h=u.nextSibling,p=s?s.nodeValue.length-r:0;h;h=h.nextSibling){if(f=n(h,h.firstChild,0))return oa(H(f.line,f.ch-p),a)
p+=h.textContent.length}for(var m=u.previousSibling,v=r;m;m=m.previousSibling){if(f=n(m,m.firstChild,-1))return oa(H(f.line,f.ch+v),a)
v+=m.textContent.length}}var ua=navigator.userAgent,ca=navigator.platform,da=/gecko\/\d/i.test(ua),fa=/MSIE \d/.test(ua),ha=/Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(ua),pa=/Edge\/(\d+)/.exec(ua),ga=fa||ha||pa,ma=ga&&(fa?document.documentMode||6:+(pa||ha)[1]),va=!pa&&/WebKit\//.test(ua),ya=va&&/Qt\/\d+\.\d+/.test(ua),ba=!pa&&/Chrome\//.test(ua),wa=/Opera\//.test(ua),xa=/Apple Computer/.test(navigator.vendor),ka=/Mac OS X 1\d\D([8-9]|\d\d)\D/.test(ua),Ca=/PhantomJS/.test(ua),Sa=!pa&&/AppleWebKit/.test(ua)&&/Mobile\/\w+/.test(ua),La=/Android/.test(ua),Ta=Sa||La||/webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(ua),Ma=Sa||/Mac/.test(ca),Na=/\bCrOS\b/.test(ua),Aa=/win/i.test(ca),Oa=wa&&ua.match(/Version\/(\d*\.\d*)/)
Oa&&(Oa=Number(Oa[1])),Oa&&Oa>=15&&(wa=!1,va=!0)
var Wa,za=Ma&&(ya||wa&&(null==Oa||Oa<12.11)),Da=da||ga&&ma>=9,Pa=function(t,r){var n=t.className,i=e(r).exec(n)
...
Sa?Ha=function(e){e.selectionStart=0,e.selectionEnd=e.value.length}:ga&&(Ha=function(e){try{e.select()}catch(e){}})
...
B<F&&I.splice(j,0,new t(1,B,F))}return"ltr"==n&&(1==I[0].level&&(E=r.match(/^\s+/))&&(I[0].from=E[0].length,I.unshift(new t(0,0,E[0].length))),1==g(I).level&&(E=r.match(/\s+$/))&&(g(I).to-=E[0].length,I.push(new t(0,c-E[0].length,c)))),"rtl"==n?I.reverse():I}}(),Za=[],Qa=function(e,t,r){if(e.addEventListener)e.addEventListener(t,r,!1)
...
return t&&t.lookAhead(e)},ll.prototype.baseToken=function(){var e=this.lineOracle
return e&&e.baseToken(this.pos)}
var sl=function(e,t){this.state=e,this.lookAhead=t},ul=function(e,t,r,n){this.state=t,this.doc=e,this.line=r,this.maxLookAhead=n||0,this.baseTokens=null,this.baseTokenPos=1}
ul.prototype.lookAhead=function(e){var t=this.doc.getLine(this.line+e)
return null!=t&&e>this.maxLookAhead&&(this.maxLookAhead=e),t},ul.prototype.baseToken=function(e){var t=this
if(!this.baseTokens)return null
for(;this.baseTokens[this.baseTokenPos]<=e;)t.baseTokenPos+=2
var r=this.baseTokens[this.baseTokenPos+1]
return{type:r&&r.replace(/( |^)overlay .*/,""),size:this.baseTokens[this.baseTokenPos]-e}},ul.prototype.nextLine=function(){this.line++,this.maxLookAhead>0&&this.maxLookAhead--},ul.fromSaved=function(e,t,r){return t instanceof sl?new ul(e,Ge(e.mode,t.state),r,t.lookAhead):new ul(e,Ge(e.mode,t),r)},ul.prototype.save=function(e){var t=!1!==e?Ge(this.doc.mode,this.state):this.state
...
kl.prototype.signal=function(e,t){Ae(e,t)&&this.events.push(arguments)},kl.prototype.finish=function(){for(var e=this,t=0;t<this.events.length;t++)Te.apply(null,e.events[t])}
var Cl=0,Sl=null
...
if(!I(n.anchor,i.anchor)||!I(n.head,i.head))return!1}return!0},Ll.prototype.deepCopy=function(){for(var e=this,t=[],r=0;r<this.ranges.length;r++)t[r]=new Tl(F(e.ranges[r].anchor),F(e.ranges[r].head))
...
var Tl=function(e,t){this.anchor=e,this.head=t}
Tl.prototype.from=function(){return B(this.anchor,this.head)},Tl.prototype.to=function(){return R(this.anchor,this.head)},Tl.prototype.empty=function(){return this.head.line==this.anchor.line&&this.head.ch==this.anchor.ch},Bi.prototype={chunkSize:function(){return this.lines.length},removeInner:function(e,t){for(var r=this,n=e,i=e+t;n<i;++n){var o=r.lines[n]
...
if(0==(t-=l))break
e=0}else e-=a}}}
var Ml=function(e,t,r){var n=this
if(r)for(var i in r)r.hasOwnProperty(i)&&(n[i]=r[i])
this.doc=e,this.node=t}
Ml.prototype.clear=function(){var e=this,t=this.doc.cm,r=this.line.widgets,n=this.line,i=W(n)
if(null!=i&&r){for(var o=0;o<r.length;++o)r[o]==e&&r.splice(o--,1)
r.length||(n.widgets=null)
var a=Dt(this)
O(n,Math.max(0,n.height-a)),t&&(fn(t,function(){Vi(t,n,-a),vn(t,i,"widget")}),bt(t,"lineWidgetCleared",t,this,i))}},Ml.prototype.changed=function(){var e=this,t=this.height,r=this.doc.cm,n=this.line
this.height=null
var i=Dt(this)-t
i&&(O(n,n.height+i),r&&fn(r,function(){r.curOp.forceUpdate=!0,Vi(r,n,i),bt(r,"lineWidgetChanged",r,e,W(n))}))},Oe(Ml)
...
if(null!=l.from&&(n=H(t?a:W(a),l.from),-1==e))return n
if(null!=l.to&&(i=H(t?a:W(a),l.to),1==e))return i}return n&&{from:n,to:i}},Al.prototype.changed=function(){var e=this,t=this.find(-1,!0),r=this,n=this.doc.cm
...
return!1===e?t:t.join(e||this.lineSeparator())},setValue:gn(function(e){var t=H(this.first,0),r=this.first+this.size-1
Ai(this,{from:t,to:H(r,M(this,r).text.length),text:this.splitLines(e),origin:"setValue",full:!0},!0),this.cm&&qr(this.cm,0,0),bi(this,Rn(t),ja)}),replaceRange:function(e,t,r,n){Hi(this,e,t=V(this,t),r=r?V(this,r):t,n)},getRange:function(e,t,r){var n=N(this,V(this,e),V(this,t))
return!1===r?n:n.join(r||this.lineSeparator())},getLine:function(e){var t=this.getLineHandle(e)
return t&&t.text},getLineHandle:function(e){if(D(this,e))return M(this,e)},getLineNumber:function(e){return W(e)},getLineHandleVisualStart:function(e){return"number"==typeof e&&(e=M(this,e)),de(e)},lineCount:function(){return this.size},firstLine:function(){return this.first},lastLine:function(){return this.first+this.size-1},clipPos:function(e){return V(this,e)},getCursor:function(e){var t=this.sel.primary()
return null==e||"head"==e?t.head:"anchor"==e?t.anchor:"end"==e||"to"==e||!1===e?t.to():t.from()},listSelections:function(){return this.sel.ranges},somethingSelected:function(){return this.sel.somethingSelected()},setCursor:gn(function(e,t,r){mi(this,V(this,"number"==typeof e?H(e,t||0):e),null,r)}),setSelection:gn(function(e,t,r){mi(this,V(this,e),V(this,t||e),r)}),extendSelection:gn(function(e,t,r){hi(this,V(this,e),t&&V(this,t),r)}),extendSelections:gn(function(e,t){pi(this,G(this,e),t)}),extendSelectionsBy:gn(function(e,t){pi(this,G(this,m(this.sel.ranges,e)),t)}),setSelections:gn(function(e,t,r){var n=this
if(e.length){for(var i=[],o=0;o<e.length;o++)i[o]=new Tl(V(n,e[o].anchor),V(n,e[o].head))
...
n.push(new Tl(V(this,e),V(this,t||e))),bi(this,Fn(n,n.length-1),r)}),getSelection:function(e){for(var t,r=this,n=this.sel.ranges,i=0;i<n.length;i++){var o=N(r,n[i].from(),n[i].to())
...
return e=V(this,e),Gi(this,e,e,r,"bookmark")},findMarksAt:function(e){var t=[],r=M(this,(e=V(this,e)).line).markedSpans
...
if(o>e)return t=e,!0
e-=o,++r}),V(this,H(r,t))},indexFromPos:function(e){var t=(e=V(this,e)).ch
...
return{from:t.from(),to:n}})},undo:function(e){return e.undo()},redo:function(e){return e.redo()},undoSelection:function(e){return e.undoSelection()},redoSelection:function(e){return e.redoSelection()},goDocStart:function(e){return e.extendSelection(H(e.firstLine(),0))},goDocEnd:function(e){return e.extendSelection(H(e.lastLine()))},goLineStart:function(e){return e.extendSelectionsBy(function(t){return mo(e,t.head.line)},{origin:"+move",bias:1})},goLineStartSmart:function(e){return e.extendSelectionsBy(function(t){return yo(e,t.head)},{origin:"+move",bias:1})},goLineEnd:function(e){return e.extendSelectionsBy(function(t){return vo(e,t.head.line)},{origin:"+move",bias:-1})},goLineRight:function(e){return e.extendSelectionsBy(function(t){var r=e.cursorCoords(t.head,"div").top+5
...
t.push(p(n-a%n))}e.replaceSelections(t)},defaultTab:function(e){e.somethingSelected()?e.indentSelection("add"):e.execCommand("insertTab")},transposeChars:function(e){return fn(e,function(){for(var t=e.listSelections(),r=[],n=0;n<t.length;n++)if(t[n].empty()){var i=t[n].head,o=M(e.doc,i.line).text
if(o)if(i.ch==o.length&&(i=new H(i.line,i.ch-1)),i.ch>0)i=new H(i.line,i.ch+1),e.replaceRange(o.charAt(i.ch-1)+o.charAt(i.ch-2),H(i.line,i.ch-2),i,"+transpose")
else if(i.line>e.doc.first){var a=M(e.doc,i.line-1).text
a&&(i=new H(i.line,1),e.replaceRange(o.charAt(0)+e.doc.lineSeparator()+a.charAt(a.length-1),H(i.line-1,a.length-1),i,"+transpose"))}r.push(new Tl(i,i))}e.setSelections(r)})},newlineAndIndent:function(e){return fn(e,function(){for(var t=e.listSelections(),r=t.length-1;r>=0;r--)e.replaceRange(e.doc.lineSeparator(),t[r].anchor,t[r].head,"+input")
t=e.listSelections()
...
Zl.prototype.init=function(e){function t(e){if(!Me(i,e)){if(i.somethingSelected())_o({lineWise:!1,text:i.getSelections()}),"cut"==e.type&&i.replaceSelection("",null,"cut")
...
Ha(l),setTimeout(function(){i.display.lineSpace.removeChild(a),s.focus(),s==o&&n.showPrimarySelection()},50)}}var r=this,n=this,i=n.cm,o=n.div=e.lineDiv
Jo(o,i.options.spellcheck),Qa(o,"paste",function(e){Me(i,e)||Yo(e,i)||ma<=11&&setTimeout(hn(i,function(){return r.updateFromDOM()}),20)}),Qa(o,"compositionstart",function(e){r.composing={data:e.data,done:!1}}),Qa(o,"compositionupdate",function(e){r.composing||(r.composing={data:e.data,done:!1})}),Qa(o,"compositionend",function(e){r.composing&&(e.data!=r.composing.data&&r.readFromDOMSoon(),r.composing.done=!0)}),Qa(o,"touchstart",function(){return n.forceCompositionEnd()}),Qa(o,"input",function(){r.composing||r.readFromDOMSoon()}),Qa(o,"copy",t),Qa(o,"cut",t)},Zl.prototype.prepareSelection=function(){var e=Tr(this.cm,!1)
...
if(0==n.ch&&n.line>e.firstLine()&&(n=H(n.line-1,M(e.doc,n.line-1).length)),i.ch==M(e.doc,i.line).text.length&&i.line<e.lastLine()&&(i=H(i.line+1,0)),n.line<t.viewFrom||i.line>t.viewTo-1)return!1
var o,a,l
...
for(var d=e.doc.splitLines(aa(e,l,u,a,s)),f=N(e.doc,H(a,0),H(s,M(e.doc,s).text.length));d.length>1&&f.length>1;)if(g(d)==g(f))d.pop(),f.pop(),s--
...
Ql.prototype.init=function(e){function t(e){if(!Me(i,e)){if(i.somethingSelected())_o({lineWise:!1,text:i.getSelections()})
else{if(!i.options.lineWiseCopyCut)return
var t=Qo(i)
_o({lineWise:!0,text:t.text}),"cut"==e.type?i.setSelections(t.ranges,null,ja):(n.prevInput="",a.value=t.text.join("\n"),Ha(a))}"cut"==e.type&&(i.state.cutIncoming=!0)}}var r=this,n=this,i=this.cm,o=this.wrapper=ea(),a=this.textarea=o.firstChild
e.wrapper.insertBefore(o,e.wrapper.firstChild),Sa&&(a.style.width="0px"),Qa(a,"input",function(){ga&&ma>=9&&r.hasSelection&&(r.hasSelection=null),n.poll()}),Qa(a,"paste",function(e){Me(i,e)||Yo(e,i)||(i.state.pasteIncoming=!0,n.fastPoll())}),Qa(a,"cut",t),Qa(a,"copy",t),Qa(e.scroller,"paste",function(t){Pt(e,t)||Me(i,t)||(i.state.pasteIncoming=!0,n.focus())}),Qa(e.lineSpace,"selectstart",function(t){Pt(e,t)||We(t)}),Qa(a,"compositionstart",function(){var e=i.getCursor("from")
n.composing&&n.composing.range.clear(),n.composing={start:e,range:i.markText(e,i.getCursor("to"),{className:"CodeMirror-composing"})}}),Qa(a,"compositionend",function(){n.composing&&(n.poll(),n.composing.range.clear(),n.composing=null)})},Ql.prototype.prepareSelection=function(){var e=this.cm,t=e.display,r=e.doc,n=Tr(e)
...
if(ga&&ma>=9&&this.hasSelection===i||Ma&&/[\uf700-\uf7ff]/.test(i))return t.display.input.reset(),!1
...
var e=0,r=function(){o.selForContextMenu==i.doc.sel&&0==a.selectionStart&&a.selectionEnd>0&&"​"==n.prevInput?hn(i,Mi)(i):e++<10?o.detectingSelectAll=setTimeout(r,500):(o.selForContextMenu=null,o.input.reset())}
...
var f
if(va&&(f=window.scrollY),o.input.focus(),va&&window.scrollTo(null,f),o.input.reset(),i.somethingSelected()||(a.value=n.prevInput=" "),n.contextMenuPending=!0,o.selForContextMenu=i.doc.sel,clearTimeout(o.detectingSelectAll),ga&&ma>=9&&t(),Da){Pe(e)
...
n[e]==r&&"mode"!=e||(n[e]=r,t.hasOwnProperty(e)&&hn(this,t[e])(this,r,i),Te(this,"optionChange",this,e))},getOption:function(e){return this.options[e]},getDoc:function(){return this.doc},addKeyMap:function(e,t){this.state.keyMaps[t?"push":"unshift"](uo(e))},removeKeyMap:function(e){for(var t=this.state.keyMaps,r=0;r<t.length;++r)if(t[r]==e||t[r].name==e)return t.splice(r,1),!0},addOverlay:pn(function(t,r){var n=t.token?t:e.getMode(this.options,t)
...
0==a.ch&&r.length==c.length&&c[i].from().ch>0&&gi(t.doc,i,new Tl(a,c[i].to()),ja)}}}),getTokenAt:function(e,t){return Je(this,e,t)},getLineTokens:function(e,t){return Je(this,H(e),t,!0)},getTokenTypeAt:function(e){e=V(this.doc,e)
var t,r=_e(this,M(this.doc,e.line)),n=0,i=(r.length-1)/2,o=e.ch
if(0==o)t=r[2]
...
var s=ra(r,l,e,t)
return"page"==t&&a==n.sel.primary()&&Gr(r,ar(r,s,"div").top-l.top),s},Ka),i.length)for(var a=0;a<n.sel.ranges.length;a++)n.sel.ranges[a].goalColumn=i[a]}),findWordAt:function(e){var t=M(this.doc,e.line).text,r=e.ch,n=e.ch
...
for(;n<t.length&&a(t.charAt(n));)++n}return new Tl(H(e.line,r),H(e.line,n))},toggleOverwrite:function(e){null!=e&&e==this.state.overwrite||((this.state.overwrite=!this.state.overwrite)?l(this.display.cursorDiv,"CodeMirror-overwrite"):Pa(this.display.cursorDiv,"CodeMirror-overwrite"),Te(this,"overwriteToggle",this,this.state.overwrite))},hasFocus:function(){return this.display.input.getField()==a()},isReadOnly:function(){return!(!this.options.readOnly&&!this.doc.cantEdit)},scrollTo:pn(function(e,t){qr(this,e,t)}),getScrollInfo:function(){var e=this.display.scroller
return{left:e.scrollLeft,top:e.scrollTop,height:e.scrollHeight-Ft(this)-this.display.barHeight,width:e.scrollWidth-Ft(this)-this.display.barWidth,clientHeight:Bt(this),clientWidth:Rt(this)}},scrollIntoView:pn(function(e,t){null==e?(e={from:this.doc.sel.primary().head,to:null},null==t&&(t=this.options.cursorScrollMargin)):"number"==typeof e?e={from:H(e,0),to:null}:null==e.from&&(e={from:e,to:null}),e.to||(e.to=e.from),e.margin=t||0,null!=e.from.line?$r(this,e):Xr(this,e.from,e.to,e.margin)}),setSize:pn(function(e,t){var r=this,n=function(e){return"number"==typeof e||/^\d+$/.test(String(e))?e+"px":e}
...
break}++i}),this.curOp.forceUpdate=!0,Te(this,"refresh",this)}),operation:function(e){return fn(this,e)},startOperation:function(){return nn(this)},endOperation:function(){return on(this)},refresh:pn(function(){var e=this.display.cachedTextHeight
mn(this),this.curOp.forceUpdate=!0,er(this),qr(this,this.doc.scrollLeft,this.doc.scrollTop),Wn(this),(null==e||Math.abs(e-vr(this.display))>.5)&&kr(this),Te(this,"refresh",this)}),swapDoc:pn(function(e){var t=this.doc
...
return s},function(e){e.off=Le,e.on=Qa,e.wheelEventPixels=En,e.Doc=zl,e.splitLines=el,e.countColumn=d,e.findColumn=h,e.isWordChar=w,e.Pass=Ba,e.signal=Te,e.Line=dl,e.changeEnd=Bn,e.scrollbarModel=wl,e.Pos=H,e.cmpPos=E,e.modes=il,e.mimeModes=ol,e.resolveMode=je,e.getMode=Ve,e.modeExtensions=al,e.extendMode=Ke,e.copyState=Ge,e.startState=qe,e.innerMode=Ue,e.commands=Bl,e.keyMap=Rl,e.keyName=so,e.isModifierKey=ao,e.lookupKey=oo,e.normalizeKeyMap=io,e.StringStream=ll,e.SharedTextMarker=Ol,e.TextMarker=Al,e.LineWidget=Ml,e.e_preventDefault=We,e.e_stopPropagation=ze,e.e_stop=Pe,e.addClass=l,e.contains=o,e.rmClass=Pa,e.keyNames=Hl}(Uo),Uo.version="5.31.0",Uo}),function(e){"object"==typeof exports&&"object"==typeof module?e(require("../../lib/codemirror")):"function"==typeof define&&define.amd?define(["../../lib/codemirror"],e):e(CodeMirror)}(function(e){"use strict"
...
var p,g,m=t.indentUnit,v=r.tokenHooks,y=r.documentTypes||{},b=r.mediaTypes||{},w=r.mediaFeatures||{},x=r.mediaValueKeywords||{},k=r.propertyKeywords||{},C=r.nonStandardPropertyKeywords||{},S=r.fontProperties||{},L=r.counterDescriptors||{},T=r.colorKeywords||{},M=r.valueKeywords||{},N=r.allowNested,A=r.lineComment,O=!0===r.supportsAtComponent,W={}
...
"["==t?n=!0:n&&"]"==t&&(n=!1)}r=!r&&"\\"==t}}function i(e,t,r){return Le=e,Te=r,t}function o(e,t){var r=e.next()
...
if("/"==r)return e.eat("*")?(t.tokenize=l,l(e,t)):e.eat("/")?(e.skipToEnd(),i("comment","comment")):Se(e,t,1)?(n(e),e.match(/^\b(([gimyu])(?![gimyu]*\2))+\b/),i("regexp","string-2")):(e.eat("="),i("operator","operator",e.current()))
if("`"==r)return t.tokenize=s,s(e,t)
if("#"==r)return e.skipToEnd(),i("error","error")
if(Pe.test(r))return">"==r&&t.lexical&&">"==t.lexical.type||(e.eat("=")?"!"!=r&&"="!=r||e.eat("="):/[<>*+\-]/.test(r)&&(e.eat(r),">"==r&&e.eat(r))),i("operator","operator",e.current())
if(ze.test(r)){e.eatWhile(ze)
var o=e.current()
if("."!=t.lastType){if(De.propertyIsEnumerable(o)){var u=De[o]
...
if(Ae&&"@"==t.peek()&&t.match(He))return r.tokenize=o,i("jsonld-keyword","meta")
...
for(Fe.state=e,Fe.stream=i,Fe.marked=null,Fe.cc=o,Fe.style=t,e.lexical.hasOwnProperty("align")||(e.lexical.align=!0);;)if((o.length?o.pop():Oe?k:x)(r,n)){for(;o.length&&o[o.length-1].lex;)o.pop()()
return Fe.marked?Fe.marked:"variable"==r&&d(e,n)?"variable-2":t}}function h(){for(var e=arguments.length-1;e>=0;e--)Fe.cc.push(arguments[e])}function p(){return h.apply(null,arguments),!0}function g(e){function t(t){for(var r=t;r;r=r.next)if(r.name==e)return!0
return!1}var n=Fe.state
if(Fe.marked="def",n.context){if(t(n.localVars))return
n.localVars={name:e,next:n.localVars}}else{if(t(n.globalVars))return
r.globalVars&&(n.globalVars={name:e,next:n.globalVars})}}function m(){Fe.state.context={prev:Fe.state.context,vars:Fe.state.localVars},Fe.state.localVars=Re}function v(){Fe.state.localVars=Fe.state.context.vars,Fe.state.context=Fe.state.context.prev}function y(e,t){var r=function(){var r=Fe.state,n=r.indented
if("stat"==r.lexical.type)n=r.lexical.indented
else for(var i=r.lexical;i&&")"==i.type&&i.align;i=i.prev)n=i.indented
r.lexical=new c(n,Fe.stream.column(),e,null,r.lexical,t)}
return r.lex=!0,r}function b(){var e=Fe.state
e.lexical.prev&&(")"==e.lexical.type&&(e.indented=e.lexical.indented),e.lexical=e.lexical.prev)}function w(e){function t(r){return r==e?p():";"==e?h():p(t)}return t}function x(e,t){return"var"==e?p(y("vardef",t.length),Z,w(";"),b):"keyword a"==e?p(y("form"),S,x,b):"keyword b"==e?p(y("form"),x,b):"keyword d"==e?Fe.stream.match(/^\s*$/,!1)?p():p(y("stat"),T,w(";"),b):"debugger"==e?p(w(";")):"{"==e?p(y("}"),K,b):";"==e?p():"if"==e?("else"==Fe.state.lexical.info&&Fe.state.cc[Fe.state.cc.length-1]==b&&Fe.state.cc.pop()(),p(y("form"),S,x,b,re)):"function"==e?p(se):"for"==e?p(y("form"),ne,x,b):"variable"==e?We&&"type"==t?(Fe.marked="keyword",p(U,w("operator"),U,w(";"))):We&&"declare"==t?(Fe.marked="keyword",p(x)):p(y("stat"),E):"switch"==e?p(y("form"),S,w("{"),y("}","switch"),K,b,b):"case"==e?p(k,w(":")):"default"==e?p(w(":")):"catch"==e?p(y("form"),m,w("("),ue,w(")"),x,b,v):"class"==e?p(y("form"),de,b):"export"==e?p(y("stat"),ge,b):"import"==e?p(y("stat"),ve,b):"module"==e?p(y("form"),Q,w("{"),y("}"),K,b,b):"async"==e?p(x):"@"==t?p(k,x):h(y("stat"),k,w(";"),b)}function k(e){return L(e,!1)}function C(e){return L(e,!0)}function S(e){return"("!=e?h():p(y(")"),k,w(")"),b)}function L(e,t){if(Fe.state.fatArrowAt==Fe.stream.start){var r=t?z:W
if("("==e)return p(m,y(")"),j(ue,")"),b,w("=>"),r,v)
if("variable"==e)return h(m,Q,w("=>"),r,v)}var n=t?N:M
return Ie.hasOwnProperty(e)?p(n):"function"==e?p(se,n):"class"==e?p(y("form"),ce,b):"keyword c"==e||"async"==e?p(t?C:k):"("==e?p(y(")"),T,w(")"),b,n):"operator"==e||"spread"==e?p(t?C:k):"["==e?p(y("]"),ke,b,n):"{"==e?V(F,"}",null,n):"quasi"==e?h(A,n):"new"==e?p(D(t)):p()}function T(e){return e.match(/[;\}\)\],]/)?h():h(k)}function M(e,t){return","==e?p(k):N(e,t,!1)}function N(e,t,r){var n=0==r?M:N,i=0==r?k:C
return"=>"==e?p(m,r?z:W,v):"operator"==e?/\+\+|--/.test(t)||We&&"!"==t?p(n):"?"==t?p(k,w(":"),i):p(i):"quasi"==e?h(A,n):";"!=e?"("==e?V(C,")","call",n):"."==e?p(I,n):"["==e?p(y("]"),T,w("]"),b,n):We&&"as"==t?(Fe.marked="keyword",p(U,n)):"regexp"==e?(Fe.state.lastType=Fe.marked="operator",Fe.stream.backUp(Fe.stream.pos-Fe.stream.start-1),p(i)):void 0:void 0}function A(e,t){return"quasi"!=e?h():"${"!=t.slice(t.length-2)?p(A):p(k,O)}function O(e){if("}"==e)return Fe.marked="string-2",Fe.state.tokenize=s,p(A)}function W(e){return u(Fe.stream,Fe.state),h("{"==e?x:k)}function z(e){return u(Fe.stream,Fe.state),h("{"==e?x:C)}function D(e){return function(t){return"."==t?p(e?H:P):"variable"==t&&We?p(Y,e?N:M):h(e?C:k)}}function P(e,t){if("target"==t)return Fe.marked="keyword",p(M)}function H(e,t){if("target"==t)return Fe.marked="keyword",p(N)}function E(e){return":"==e?p(b,x):h(M,w(";"),b)}function I(e){if("variable"==e)return Fe.marked="property",p()}function F(e,t){if("async"==e)return Fe.marked="property",p(F)
if("variable"==e||"keyword"==Fe.style){if(Fe.marked="property","get"==t||"set"==t)return p(R)
var r
return We&&Fe.state.fatArrowAt==Fe.stream.start&&(r=Fe.stream.match(/^\s*:\s*/,!1))&&(Fe.state.fatArrowAt=Fe.stream.pos+r[0].length),p(B)}return"number"==e||"string"==e?(Fe.marked=Ae?"property":Fe.style+" property",p(B)):"jsonld-keyword"==e?p(B):"modifier"==e?p(F):"["==e?p(k,w("]"),B):"spread"==e?p(C,B):"*"==t?(Fe.marked="keyword",p(F)):":"==e?h(B):void 0}function R(e){return"variable"!=e?h(B):(Fe.marked="property",p(se))}function B(e){return":"==e?p(C):"("==e?h(se):void 0}function j(e,t,r){function n(i,o){if(r?r.indexOf(i)>-1:","==i){var a=Fe.state.lexical
return"call"==a.info&&(a.pos=(a.pos||0)+1),p(function(r,n){return r==t||n==t?h():h(e)},n)}return i==t||o==t?p():p(w(t))}return function(r,i){return r==t||i==t?p():h(e,n)}}function V(e,t,r){for(var n=3;n<arguments.length;n++)Fe.cc.push(arguments[n])
return p(y(t,r),j(e,t),b)}function K(e){return"}"==e?p():h(x,K)}function G(e,t){if(We){if(":"==e)return p(U)
if("?"==t)return p(G)}}function U(e,t){return"variable"==e||"void"==t?"keyof"==t?(Fe.marked="keyword",p(U)):(Fe.marked="type",p(X)):"string"==e||"number"==e||"atom"==e?p(X):"["==e?p(y("]"),j(U,"]",","),b,X):"{"==e?p(y("}"),j($,"}",",;"),b,X):"("==e?p(j(_,")"),q):void 0}function q(e){if("=>"==e)return p(U)}function $(e,t){return"variable"==e||"keyword"==Fe.style?(Fe.marked="property",p($)):"?"==t?p($):":"==e?p(U):"["==e?p(k,G,w("]"),$):void 0}function _(e){return"variable"==e?p(_):":"==e?p(U):void 0}function X(e,t){return"<"==t?p(y(">"),j(U,">"),b,X):"|"==t||"."==e?p(U):"["==e?p(w("]"),X):"extends"==t?p(U):void 0}function Y(e,t){if("<"==t)return p(y(">"),j(U,">"),b,X)}function Z(){return h(Q,G,ee,te)}function Q(e,t){return"modifier"==e?p(Q):"variable"==e?(g(t),p()):"spread"==e?p(Q):"["==e?V(Q,"]"):"{"==e?V(J,"}"):void 0}function J(e,t){return"variable"!=e||Fe.stream.match(/^\s*:/,!1)?("variable"==e&&(Fe.marked="property"),"spread"==e?p(Q):"}"==e?h():p(w(":"),Q,ee)):(g(t),p(ee))}function ee(e,t){if("="==t)return p(C)}function te(e){if(","==e)return p(Z)}function re(e,t){if("keyword b"==e&&"else"==t)return p(y("form","else"),x,b)}function ne(e){if("("==e)return p(y(")"),ie,w(")"),b)}function ie(e){return"var"==e?p(Z,w(";"),ae):";"==e?p(ae):"variable"==e?p(oe):h(k,w(";"),ae)}function oe(e,t){return"in"==t||"of"==t?(Fe.marked="keyword",p(k)):p(M,ae)}function ae(e,t){return";"==e?p(le):"in"==t||"of"==t?(Fe.marked="keyword",p(k)):h(k,w(";"),le)}function le(e){")"!=e&&p(k)}function se(e,t){return"*"==t?(Fe.marked="keyword",p(se)):"variable"==e?(g(t),p(se)):"("==e?p(m,y(")"),j(ue,")"),b,G,x,v):We&&"<"==t?p(y(">"),j(U,">"),b,se):void 0}function ue(e,t){return"@"==t&&p(k,ue),"spread"==e||"modifier"==e?p(ue):h(Q,G,ee)}function ce(e,t){return"variable"==e?de(e,t):fe(e,t)}function de(e,t){if("variable"==e)return g(t),p(fe)}function fe(e,t){return"<"==t?p(y(">"),j(U,">"),b,fe):"extends"==t||"implements"==t||We&&","==e?p(We?U:k,fe):"{"==e?p(y("}"),he,b):void 0}function he(e,t){return"modifier"==e||"async"==e||"variable"==e&&("static"==t||"get"==t||"set"==t)&&Fe.stream.match(/^\s+[\w$\xa1-\uffff]/,!1)?(Fe.marked="keyword",p(he)):"variable"==e||"keyword"==Fe.style?(Fe.marked="property",p(We?pe:se,he)):"["==e?p(k,w("]"),We?pe:se,he):"*"==t?(Fe.marked="keyword",p(he)):";"==e?p(he):"}"==e?p():"@"==t?p(k,he):void 0}function pe(e,t){return"?"==t?p(pe):":"==e?p(U,ee):"="==t?p(C):h(se)}function ge(e,t){return"*"==t?(Fe.marked="keyword",p(xe,w(";"))):"default"==t?(Fe.marked="keyword",p(k,w(";"))):"{"==e?p(j(me,"}"),xe,w(";")):h(x)}function me(e,t){return"as"==t?(Fe.marked="keyword",p(w("variable"))):"variable"==e?h(C,me):void 0}function ve(e){return"string"==e?p():h(ye,be,xe)}function ye(e,t){return"{"==e?V(ye,"}"):("variable"==e&&g(t),"*"==t&&(Fe.marked="keyword"),p(we))}function be(e){if(","==e)return p(ye,be)}function we(e,t){if("as"==t)return Fe.marked="keyword",p(ye)}function xe(e,t){if("from"==t)return Fe.marked="keyword",p(k)}function ke(e){return"]"==e?p():h(j(C,"]"))}function Ce(e,t){return"operator"==e.lastType||","==e.lastType||Pe.test(t.charAt(0))||/[,.]/.test(t.charAt(0))}function Se(e,t,r){return t.tokenize==o&&/^(?:operator|sof|keyword [bcd]|case|new|export|default|spread|[\[{}\(,;:]|=>)$/.test(t.lastType)||"quasi"==t.lastType&&/\{\s*$/.test(e.string.slice(0,e.pos-(r||0)))}var Le,Te,Me=t.indentUnit,Ne=r.statementIndent,Ae=r.jsonld,Oe=r.json||Ae,We=r.typescript,ze=r.wordCharacters||/[\w$\xa1-\uffff]/,De=function(){function e(e){return{type:e,style:"keyword"}}var t=e("keyword a"),r=e("keyword b"),n=e("keyword c"),i=e("keyword d"),o=e("operator"),a={type:"atom",style:"atom"},l={if:e("if"),while:t,with:t,else:r,do:r,try:r,finally:r,return:i,break:i,continue:i,new:e("new"),delete:n,void:n,throw:n,debugger:e("debugger"),var:e("var"),const:e("var"),let:e("var"),function:e("function"),catch:e("catch"),for:e("for"),switch:e("switch"),case:e("case"),default:e("default"),in:o,typeof:o,instanceof:o,true:a,false:a,null:a,undefined:a,NaN:a,Infinity:a,this:e("this"),class:e("class"),super:e("atom"),yield:n,export:e("export"),import:e("import"),extends:n,await:n}
if(We){var s={type:"variable",style:"type"},u={interface:e("class"),implements:n,namespace:n,module:e("module"),enum:e("module"),public:e("modifier"),private:e("modifier"),protected:e("modifier"),abstract:e("modifier"),readonly:e("modifier"),string:s,number:s,boolean:s,any:s}
for(var c in u)l[c]=u[c]}return l}(),Pe=/[+\-*&%=<>!?|~^@]/,He=/^@(context|id|value|language|type|container|list|set|reverse|index|base|vocab|graph)"/,Ee="([{}])",Ie={atom:!0,number:!0,variable:!0,string:!0,regexp:!0,this:!0,"jsonld-keyword":!0},Fe={state:null,column:null,marked:null,cc:null},Re={name:"this",next:{name:"arguments"}}
return b.lex=!0,{startState:function(e){var t={tokenize:o,lastType:"sof",cc:[],lexical:new c((e||0)-Me,0,"block",!1),localVars:r.localVars,context:r.localVars&&{vars:r.localVars},indented:e||0}
...
return"comment"==Le?r:(t.lastType="operator"!=Le||"++"!=Te&&"--"!=Te?Le:"incdec",f(t,r,Le,Te,e))},indent:function(t,n){if(t.tokenize==l)return e.Pass
if(t.tokenize!=o)return 0
var i,a=n&&n.charAt(0),s=t.lexical
if(!/^\s*else\b/.test(n))for(var u=t.cc.length-1;u>=0;--u){var c=t.cc[u]
if(c==b)s=s.prev
else if(c!=re)break}for(;("stat"==s.type||"form"==s.type)&&("}"==a||(i=t.cc[t.cc.length-1])&&(i==M||i==N)&&!/^[,\.=+\-*:?[\(]/.test(n));)s=s.prev
Ne&&")"==s.type&&"stat"==s.prev.type&&(s=s.prev)
var d=s.type,f=a==d
return"vardef"==d?s.indented+("operator"==t.lastType||","==t.lastType?s.info+1:0):"form"==d&&"{"==a?s.indented:"form"==d?s.indented+Me:"stat"==d?s.indented+(Ce(t,n)?Ne||Me:0):"switch"!=s.info||f||0==r.doubleIndentSwitch?s.align?s.column+(f?0:1):s.indented+(f?0:Me):s.indented+(/^(?:case|default)\b/.test(n)?Me:2*Me)},electricInput:/^\s*(?:case .*?:|default:|\{|\})$/,blockCommentStart:Oe?null:"/*",blockCommentEnd:Oe?null:"*/",blockCommentContinue:Oe?null:" * ",lineComment:Oe?null:"//",fold:"brace",closeBrackets:"()[]{}''\"\"``",helperType:Oe?"json":"javascript",jsonldMode:Ae,jsonMode:Oe,expressionAllowed:Se,skipExpression:function(e){var t=e.cc[e.cc.length-1]
...
return"<"==n?e.eat("!")?e.eat("[")?e.match("CDATA[")?r(s("atom","]]>")):null:e.match("--")?r(s("comment","--\x3e")):e.match("DOCTYPE",!0,!0)?(e.eatWhile(/[\w\._\-]/),r(u(1))):null:e.eat("?")?(e.eatWhile(/[\w\._\-]/),t.tokenize=s("meta","?>"),"meta"):(T=e.eat("/")?"closeTag":"openTag",t.tokenize=a,"tag bracket"):"&"==n?(e.eat("#")?e.eat("x")?e.eatWhile(/[a-fA-F\d]/)&&e.eat(";"):e.eatWhile(/[\d]/)&&e.eat(";"):e.eatWhile(/[\w\.\-:]/)&&e.eat(";"))?"atom":"error":(e.eatWhile(/[^&<]/),null)}function a(e,t){var r=e.next()
